...
const colors:Record<string,string>={数学:"#8794ad",计算机:"#789b96",经济学:"#aa9474",金融:"#78977f",物理:"#9187a5",化学:"#9a8f78",生物:"#7f9b86",心理学:"#a58c9d",社会科学:"#a28f7c",历史:"#9b8875",工程学:"#8d8379",运动科学:"#77958c",营养学:"#a29072",语言:"#8f829d",文学:"#9d7f86",交叉领域:"#505860"};
...
const descriptions:Record<string,string>={
 ...
 compbio:"生物 × 计算机 × 统计",biophysics:"生物 × 物理",cogsci:"心理学 × 生物 × 计算机",behavecon:"心理学 × 经济学",neuroecon:"神经科学 × 心理学 × 经济学",compsocial:"社会科学 × 计算机 × 统计",network:"数学 × 计算机 × 自然与社会系统",econophysics:"经济学 × 统计物理",quantumcomp:"物理 × 数学 × 计算机",psychometrics:"心理学 × 统计",mathbio:"数学 × 生物",epidemiology:"生物 × 统计 × 社会科学",hci:"计算机 × 心理学 × 社会科学",compneuro:"神经科学 × 数学 × 计算机",exercise:"生物 × 生理 × 物理 × 心理 × 数据科学",nutrition:"生物 × 化学 × 心理 × 公共健康 × 运动科学"
};
