...
const initialNodes:Node[]=[
 ...
 {id:"stats",label:"概率统计",group:"数学",x:.26,y:.35,size:5},{id:"opt",label:"优化",group:"数学",x:.34,y:.19,size:5},{id:"crypto",label:"密码学",group:"数学",x:.3,y:.27,size:6},{id:"algo",label:"算法",group:"计算机",x:.55,y:.3,size:5},{id:"data",label:"数据科学",group:"计算机",x:.39,y:.4,size:5},{id:"blockchain",label:"区块链",group:"计算机",x:.51,y:.55,size:7},{id:"mechanics",label:"力学",group:"物理",x:.75,y:.38,size:5},{id:"dynamics",label:"动力系统",group:"物理",x:.68,y:.52,size:5},{id:"micro",label:"微观经济学",group:"经济学",x:.25,y:.66,size:5},{id:"macro",label:"宏观经济学",group:"经济学",x:.24,y:.82,size:5},{id:"pricing",label:"资产定价",group:"金融",x:.4,y:.68,size:5},{id:"corp",label:"公司金融",x:.59,y:.73,size:5,group:"金融"},
...
const descriptions:Record<string,string>={
 crypto:"数学 × 计算机 × 信息安全",blockchain:"计算机 × 密码学 × 分布式系统 × 经济激励",ml:"数学 × 计算机 × 统计",metrics:"经济学 × 数学 × 统计",quant:"金融 × 统计 × 计算机",fineng:"金融 × 数学 × 计算机",complex:"数学 × 物理 × 生物 × 社会科学",robot:"计算机 × 物理",
...
export default function KnowledgeGraph(){
 ...
 return <section className="knowledge-section" id="knowledge-graph">
  ...
  <div className="graph-shell">
   <canvas ref={canvasRef} onPointerDown={onPointerDown} onPointerMove={onPointerMove} onPointerUp={finish} onPointerCancel={finish} onPointerLeave={e=>{if(!dragRef.current)activate(null);e.currentTarget.classList.remove("dragging-node","panning")}} role="img" aria-label="包含计算生物学、认知科学、网络科学等领域的可拖拽跨学科知识图谱"/>
