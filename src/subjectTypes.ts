...
export type Topic={title:string;intro:string;resources:Resource[]};
export type Phase={time:string;title:string;goal:string;learn:string;done:string;link:string};
